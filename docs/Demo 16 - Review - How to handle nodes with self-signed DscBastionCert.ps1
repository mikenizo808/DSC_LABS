# Review - How to handle nodes with self-signed DscBastionCert
...
psedit "C:\DSC_LABS\docs\Demo 17 - Review - How to handle nodes with PSDSCPullServerCert from domain.ps11"